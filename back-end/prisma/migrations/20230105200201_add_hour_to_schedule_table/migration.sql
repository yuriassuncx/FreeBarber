...
INSERT INTO "new_Schedules" ("clientName", "contributorId", "createdAt", "description", "id", "status") SELECT "clientName", "contributorId", "createdAt", "description", "id", "status" FROM "Schedules";
